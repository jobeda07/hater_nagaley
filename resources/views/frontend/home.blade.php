            ...
            <div class="carausel-10-columns-cover position-relative">
                <div class="carausel-10-columns" id="carausel-10-columns">
                    @foreach ($featured_category as $cat)
                        <div class="card-2 bg-9 d-flex flex-column justify-content-center align-items-center wow animate__animated animate__fadeInUp"
                            data-wow-delay=".1s">
                                ...
                                <a href="{{ route('product.category', $cat->slug) }}">
                                    @if ($cat->image && $cat->image != '' && $cat->image != 'Null')
                                        <img class="default-img lazyload img-responsive"
                                            data-original="{{ asset($cat->image) }}"
                                            src="{{ asset('upload/product-default-sm.jpg') }}" alt="">
                                    @else
    ...
    {{-- <section class="pb-5 section-padding">
	    <div class="container">
	        ...
	        <div class="row">
	                    ...
	                    <div class="product-content-wrap">
	                        ...
	                        <div class="deals-content">
	                            ...
	                            <div class="product-card-bottom">
	                                ...
	                                <div class="add-cart">
	                                    <a class="add" href="#"><i class="mr-5 fi-rs-shopping-cart"></i>Add </a>
	                                </div>
	                            </div>
	                        </div>
	                    </div>
	            ...
	            <div class="col-xl-3 col-lg-4 col-md-6 col-12 d-none d-lg-block">
	                    ...
	                    <div class="product-content-wrap">
	                        ...
	                        <div class="deals-content">
	                            ...
	                            <div class="product-rate-cover">
	                                ...
	                                <span class="ml-5 font-small text-muted"> (3.0)</span>
	                            </div>
	                            <div>
        ...
        <section class="popular-categories section-padding">
            <div class="container wow animate__animated animate__fadeIn">
                <div class="section-title">
                    ...
                    <div class="slider-arrow slider-arrow-2 flex-right carausel-10-columns-arrow-vendors"
                        id="carausel-10-columns-arrows-vendors"></div>
                </div>
                <div class="carausel-10-columns-cover position-relative">
                    <div class="carausel-10-columns-vendors" id="carausel-10-columns-vendors">
                        @foreach (get_vendors() as $vendor)
                            <div class="mx-2 card-2 bg-9 d-flex flex-column justify-content-center align-items-center wow animate__animated animate__fadeInUp"
                                data-wow-delay=".1s">
                                <figure class="overflow-hidden img-hover-scale">
                                    <a href="{{ route('vendor.product', $vendor->slug) }}">
                                        @if ($vendor->shop_profile && $vendor->shop_profile != '' && $vendor->shop_profile != 'Null')
                                            <img class="default-img" src="{{ asset($vendor->shop_profile) }}"
                                                alt="" />
                                        @else
                            ...
                            <article class="row align-items-center hover-up">
                                ...
                                <div class="mb-0 col-md-8">
                                    ...
                                    @else
                                        @php
                                            $amount =
                                                $product_trending->regular_price - $product_trending->discount_price;
                                        @endphp
                                        <div class="product-price">
                                            <span class="price"> ৳{{ $amount }} </span>
                            ...
                            <article class="row align-items-center hover-up">
                                ...
                                <div class="mb-0 col-md-8">
                                    ...
                                    @else
                                        @php
                                            $amount =
                                                $product_top_rate->regular_price - $product_top_rate->discount_price;
                                        @endphp
                                        <div class="product-price">
                                            <span class="price"> ৳{{ $amount }} </span>
