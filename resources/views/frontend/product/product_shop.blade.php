                                        ...
                                        <div class="form-group col-lg-6 col-6 col-md-6">
                                            <div class="custom_select">
                                                <select class="form-control select-active" name="sort_by"
                                                    onchange="filter()">
                                                    <option value="newest"
                                                        @if ($sort_by == 'newest') selected @endif>Newest</option>
                                                    <option value="oldest"
                                                        @if ($sort_by == 'oldest') selected @endif>Oldest</option>
                                                    <option value="price-asc"
                                                        @if ($sort_by == 'price-asc') selected @endif>Price Low to High
                                                    </option>
                                    ...
                                    <div class="mb-10 product-cart-wrap">
                                        <div class="product-img-action-wrap">
                                            ...
                                            <div class="product-action-1 d-flex">
                                                <a aria-label="Quick view" id="{{ $product->id }}"
                                        ...
                                        <div class="pb-0 product-content-wrap">
                                            ...
                                            {{-- <div class="product-rate-cover">
                                                ...
                                                <span class="ml-5 font-small text-muted"> (0)</span>
                                            </div> --}}
                        ...
                        <div class="card">
                            <div class="border-0 sidebar-widget price_range range">
                                ...
                                <input type="hidden" id="filter_price_start" name="filter_price_start"
                                    @if (isset($_GET['filter_price_start'])) value="{{ $_GET['filter_price_start'] }}" @else value="1" @endif>
                                <input type="hidden" id="filter_price_end" name="filter_price_end"
                                    @if (isset($_GET['filter_price_end'])) value="{{ $_GET['filter_price_end'] }}" @else value="10000" @endif>
                                    ...
                                    @foreach (get_categories() as $category)
                                        <div class="mb-2">
                                            ...
                                            <input class="form-check-input" type="checkbox" name="filtercategory[]"
                                                id="category_{{ $category->id }}" value="{{ $category->name_en }}"
