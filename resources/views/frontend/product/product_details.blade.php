                                                ...
                                                @if ($product->product_video)
                                                    <div class="app-figure">
                                                        <iframe width="560" height="315"
                                                            src="{{ $product->product_video }}" frameborder="0"
                                            ...
                                            <div class="clearfix product-price-cover">
                                                <div class="float-left product-price primary-color">
                                                    @if ($product->discount_price <= 0)
                                                        @if (auth()->check() && auth()->user()->role == 7)
                                                            <span
                                                                class="current-price text-brand">৳{{ number_format($product->reseller_price) }}</span>
                                                        @else
                                                            <span
                                                    ...
                                                    @else
                                                        ...
                                                        @if (auth()->check() && auth()->user()->role == 7)
                                                            <span class="save-price font-md color3 ml-15"
                                                                style="display:none;"> ৳{{ $discount }} Off </span>
                                                        @else
                                                            @if ($product->discount_type == 1)
                                                                <span class="save-price font-md color3 ml-15">
                                                                    ৳{{ $discount }} Off </span>
                                                        ...
                                                        @if (auth()->check() && auth()->user()->role == 7)
                                                            <span class="old-price font-md ml-15"
                                                                style="display:none;">৳{{ number_format($product->reseller_price) }}</span>
                                                        @else
                                                            <span
                                            ...
                                            <div class="font-xs">
                                                <ul class="mr-50 float-start">
                                                    <li class="mb-5"><strong>Regular Price:</strong> <span
                                                            class="text-brand"
                                                            style="font-size: 14px !important;">{{ $product->regular_price }}</span>
                                                    </li>
                                                    <li class="mb-5"><strong>Stock:</strong> <span
                                                            class="text-brand product_att_stock"
                                                            style="font-size: 14px !important;">{{ $product->stock_qty }}</span>
                                                    </li>
