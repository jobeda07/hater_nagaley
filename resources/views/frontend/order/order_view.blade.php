                                    ...
                                    <table class="table table-striped invoice-table">
                                        ...
                                        <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">{{ $order_detail->price+$extra }}</td>
                                                    <td class="text-center">{{$order_detail->
                                                    qty ?? ''}}</td>
                                                    <td class="text-right">{{( $order_detail->price * $order_detail->qty)+$extra }}</td>
                                                </tr>
                                                @endforeach
                                                 <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right f-w-600">{{ ($order->grand_total - $order->discount ?? ' ')+$extraPay }}</td>
                                                </tr>
                                        </tbody>
                                    </table>
                                </div>
