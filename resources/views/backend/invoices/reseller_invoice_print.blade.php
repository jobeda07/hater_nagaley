	                ...
	                @foreach ($order->order_details as $key => $orderDetail)
		                @if ($orderDetail->product != null)
							<tr class="">
								...
								<td class="currency">{{ $orderDetail->price+$extra }}</td>
			                    <td class="text-right currency">{{ ($orderDetail->price*$orderDetail->qty)+$extra }}</td>
							</tr>
		                @endif
					@endforeach
	            </tbody>
					        ...
					        <table class="text-right small strong">
						        <tbody>
							        <tr>
							            ...
							            <td class="currency">{{ $order->sub_total+$extraPay }}</td>
							        </tr>
									@if($order->discount>0)
										<tr>
							        ...
							        <tr @if ($order->sale_type==1) class="border-bottom" @endif>
							            ...
							            <td class="currency" style="font-weight: 600;">{{ $order->grand_total+$extraPay }}</td>
							        </tr>
